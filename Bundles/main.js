...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 7, vars: 0, consts: [[1, "container"], [1, "row"], [1, "cont-img-login", "rounded", "col-md-8"], ["src", "../../../Bundles/assets/images/login-images/login.png", "alt", "imagen login", 1, "rounded"], [1, "form-container"], ["action", ""]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
